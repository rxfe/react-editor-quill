(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("quill"), require("react"), require("react-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["quill", "react", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["ReactEditorQuill"] = factory(require("quill"), require("react"), require("react-dom"));
	else
		root["ReactEditorQuill"] = factory(root["Quill"], root["React"], root["ReactDOM"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BaseEditor2 = __webpack_require__(8);
	  ...
	  */
	  ...
	  _createClass(Editor, [{
	    ...
	    value: function shouldComponentRegenerate(nextProps) {
	      ...
	      return (0, _lodash2.default)(this.dirtyProps, function (prop) {
	        return (
	          // Note that `isEqual` compares deeply, making it safe to perform
	          // non-immutable updates, at the cost of performance.
	          !(0, _lodash4.default)(nextProps[prop], _this3.props[prop])
	        );
	      });
	    }
